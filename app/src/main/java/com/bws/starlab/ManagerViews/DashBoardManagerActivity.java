...
public class DashBoardManagerActivity extends AppCompatActivity {
    ...
    private void clickEvent() {
        ...
        ll_ViewSchedule.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DashBoardManagerActivity.this,CreateJobActivity.class);
                startActivity(intent);
            }
        });
        ...
        ll_AproveTimeSheet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DashBoardManagerActivity.this,ModifyScheduleActivity.class);
                startActivity(intent);
            }
        });
        ...
        ll_ViewBillingStatus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DashBoardManagerActivity.this,CreateTimeSheetActivity.class);
                startActivity(intent);
            }
        });
