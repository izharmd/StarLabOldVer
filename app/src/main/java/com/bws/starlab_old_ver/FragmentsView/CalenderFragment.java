...
public class CalenderFragment extends Fragment implements OnClickListener{
   // Button btnAssetsDetails;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_caalender, container, false);
...
//Note : ======>> For this error i create new app so plz find that app (C:\Users\BWS\Downloads\CustomeCalendar)
    ...
    public class GridCellAdapter extends BaseAdapter implements OnClickListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (day_color[1].equals("BLUE")) {
                gridcell.setTextColor(getResources().getColor(R.color.color_green_bg));
            }

            // Use for color selected date by user
            int days = Integer.parseInt(theday);
            if(days == dayOfMonth1 && days <= dayOfMonth2){
                dayOfMonth1++;
