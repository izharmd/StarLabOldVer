...
public class AproveTimeSheetDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aprove_time_sheet_details);
        initView();
        clickEvent();
    }
    ...
    private void initView() {
        ...
        textJob_header.setText("Viw timesheet approvals");
    ...
    private void clickEvent() {
        ...
        imv_Shutdown.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(AproveTimeSheetDetailsActivity.this, LoginActivity.class);
